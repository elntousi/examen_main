 ...
 * {@link JTextField} als Meldungs-/Statusbereich. Die Anordnung erfolgt mittels
 * {@link GridBagLayout}. Die eigentliche Logik (ActionListener) wird außerhalb
 * dieses Panels registriert (z. B. im Controller).
 * </p>
 *
 * @author Eleni Ntousi
 * @version 1.0
...
public class PanelAktionen extends JPanel {
	...
	public void setDelegate(AktionPanelDelegate delegate) {
		this.delegate = delegate;
	}

	/**
	 * Erstellt das Aktionen-Panel, initialisiert alle UI-Komponenten und fügt sie
	 * gemäß Layout ein.
	 * <p>
	 ...
	 * {@code messageArea} für Statusmeldungen und setzt einen Standardtext.
	 * </p>
	 */
	...
	/**
	 * Fügt die initialisierten Komponenten dem Panel hinzu und ordnet sie mithilfe
	 * von {@link GridBagConstraints} in einem {@link GridBagLayout} an.
	 * <p>
	 * Der Meldungsbereich wird oben über drei Spalten gestreckt platziert. Darunter
	 * werden die drei Schaltflächen in einer Zeile angeordnet.
	 * </p>
	 */
	void addComponents() {
